...
//But, the insertion order affects where the number could be place. For example, say 10 and 20 is given and the center is 50. Then the 
// next could be a 25. Now it's not going in descending order on the left since the 10 and 20 already taken up space.
